...
from movies.views import MovieListView, MovieDetailView, favorite_movie, MovieCreateView, MovieUpdateView, MovieDeleteView
...
urlpatterns = [
    ...
    path('movie/<int:pk>/favorite/', favorite_movie, name='favorite_movie'),
